            ...
            for(let j = 0;j < indentData[i].bjfOrderItems.length;j++){
                if((indentData[i].odStatus === 1) || (indentData[i].odStatus === 9)){
                    ...
                    if(indentData[i].bjfOrderItems[j].oiStatus === 3){
                        str3 = `<div class="evaluate"  data-odDelid=${indentData[i].odDelid} data-oiId=${indentData[i].bjfOrderItems[j].oiId}>未评价</div>`
                    }else if(indentData[i].bjfOrderItems[j].oiStatus === 4){
                        str3 = `<div class="evaluate"  data-odDelid=${indentData[i].odDelid} data-oiId=${indentData[i].bjfOrderItems[j].oiId}>追加评价</div>`
